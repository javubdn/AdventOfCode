...
class DiagramSituation {
    ...
    func calculateMovements() -> Int {
        var allSituations: Set<AmphipodsSituation> = Set() //[AmphipodsSituation: Int] = [:]
...
//        amphipod.position.
    ...
    func amphipodTarget(_ amphipod: Amphipod, _ amphipods: [Amphipod]) -> (Int, Int) {
        ...
        if amphipodInLastPlace.isEmpty || amphipodInLastPlace.first!.type != amphipod.type {
